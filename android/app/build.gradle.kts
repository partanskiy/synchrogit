...
android {
    ...
    defaultConfig {
        ...
        minSdk = 26
        targetSdk = 36
        versionCode = providers.environmentVariable("ANDROID_VERSION_CODE").orElse("26090301").get().toInt()
        versionName = providers.environmentVariable("SYNCHROGIT_VERSION").orElse("26.9.3-dev").get()
